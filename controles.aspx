...
<head>
    ...
    form{
        ...
        margin:100px auto;
        padding:10px;
        border:1px solid rgba(4, 112, 122, 0.562);;
    ...
    input[type=submit]{
        padding:10px;
        background:rgba(4, 112, 122, 0.562);
        border:0px;
        color:#FFF;
        font-weight:bold;
    }
    input[type=text]:hover{
        background:rgba(173, 195, 202, 0.5);
    }
    </style>
</head>
    ...
    private void Botao_Click(Object sender, EventArgs ev){
        ...
        lblMensagem.Text = "Nome: "+txtNome.Text+" | E-mail: "+txtEmail.Text;
    }
